  ...
  event.waitUntil(
    caches.open(staticCacheName).then(cache => {
      return cache.addAll([
        ...
        '/static/rendezvous/js/manup.min.js',
        '/static/rendezvous/js/pwa-nav.js',
        '/static/rendezvous/css/app.css',
        '/static/mapper/avatars/male.png',
        '/static/mapper/avatars/female.png',
        '/static/mapper/avatars/ninja.png',
